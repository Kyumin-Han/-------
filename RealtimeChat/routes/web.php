...
Route::middleware(['auth:sanctum', 'verified'])->get('/chatV2', [ChatController::class, 'indexV2'])->name('chatV2');
...
Route::middleware(['auth:sanctum', 'verified'])->post('/chat/{msgId}', [ChatController::class, 'deleteMessage']);